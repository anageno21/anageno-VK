...
(function (__wpcc) {
    var r = function (a) {
        ...
        z = function (a) {
            ...
            var b = void 0 === a.el ? x() : a.el,
                ...
                B =
                    void 0 === a.boundingBoxContainer
                        ? x()
                        : a.boundingBoxContainer;
            this.settings = {
                el: b,
                zoomPane: c,
                sourceAttribute: e,
        ...
        A = function (a) {
            ...
            var c = void 0 === a.zoomFactor ? x() : a.zoomFactor,
                ...
                q =
                    void 0 === a.showWhitespaceAtEdges
                        ? x()
                        : a.showWhitespaceAtEdges,
    ...
    z.prototype._handleMovement = function (a) {
        if (a)
            this._preventDefaultAllowTouchScroll(a), (this._lastMovement = a);
    ...
    A.prototype.setPosition = function (a, b, c) {
        ...
        this.el.parentElement === this.settings.inlineContainer &&
            ...
            (a =
                c.left + a * c.width - q / 2 + this.settings.inlineOffsetX + p),
            (b =
                c.top + b * c.height - k / 2 + this.settings.inlineOffsetY + n),
            this.settings.containInline &&
                ...
                b < c.top + n
                    ? (b = c.top + n)
                    : b + k > c.top + c.height + n &&
                      (b = c.top + c.height - k + n)),
            (this.el.style.left = a + "px"),
            (this.el.style.top = b + "px"));
    ...
    __wpcc.d.global.Object.defineProperties(A.prototype, {
        _isInline: {
            ...
            get: function () {
                ...
                return (
                    !0 === a ||
                    ("number" === typeof a && window.innerWidth <= a)
                );
            },
        },
    });
